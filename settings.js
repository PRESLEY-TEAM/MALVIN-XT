...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "malvin~hrsRyIDZ#Mz6EafKL1YmRJSwPNqO6FKR1OQFynkiSxtRNbYmjTKM",
// add your Session Id make sure it starts with malvin~
PREFIX: process.env.PREFIX || ".",
// add your prifix for bot   
BOT_NAME: process.env.BOT_NAME || "ELVIS PRESLEY BOT",
...
// add alive msg here 
        ...
        STICKER_NAME: process.env.STICKER_NAME || "ELVIS PRESLEY",
...
// automatic delete links witho remove member 
          ...
          OWNER_NUMBER: process.env.OWNER_NUMBER || "25469323530",
// add your bot owner number

OWNER_NAME: process.env.OWNER_NAME || "PRESLEY TECH",
// add bot owner name

              DESCRIPTION: process.env.DESCRIPTION || "*© ᴘᴏᴡᴇʀᴇᴅ ʙʏ ELVIS PRESLEY*",
// add bot owner name    
...
START_MSG: process.env.START_MSG || `*HELLO THERE ELVIS CONNECT! 👋🏻* 
